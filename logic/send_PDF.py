...
def connect_server(stop_time):
    ...
    last = now + stop_time
    n = 0
    data = "{'token': '4a7d1ed414474e4033ac29ccb8653d9b','cmd': 1201,'data': {'id': '86111537348946189','url': ['http://192.168.100.5:13500/pdf?fileName=/storage/emulated/0/ymPrint/ftppdf/1537515086522.pdf'],'copies': 1,'mode': 0,'type': 0,'level': 0,'size': 0,'side': 1,'autoscale': 1,'start_page': 1,'end_page': 11}}"
